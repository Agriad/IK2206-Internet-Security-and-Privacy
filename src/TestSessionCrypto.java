...
public class TestSessionCrypto  {
    ...
    static String PLAININPUT =
            "/Users/Justin/Desktop/Games/Programming/Github/IK2206-internet-security-and-privacy/src/plaininput.txt";
    static String PLAINOUTPUT =
            "/Users/Justin/Desktop/Games/Programming/Github/IK2206-internet-security-and-privacy/src/plainoutput.txt";
    static String CRYPTOUT =
            "/Users/Justin/Desktop/Games/Programming/Github/IK2206-internet-security-and-privacy/src/cryptoutput.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (
            ...
            FileOutputStream cryptOutTest = new FileOutputStream(CRYPTOUT);
            FileInputStream cryptInTest = new FileInputStream(CIPHER);
            while ((b = cryptInTest.read()) != -1)
            {
                cryptOutTest.write(b);
            }
